...
def exibir_subtitulo(texto):
    '''Essa função é responsável por exibir o subtitulo dos textos
...
def listar_restaurantes():
    ...
    Output
    - retorna uma lista com o nome, categoria e status do restaurante cadastrado
    '''
...
def escolher_opcao():
    '''Essa opção é responsável por executar a opção escolhida pelo usuário
